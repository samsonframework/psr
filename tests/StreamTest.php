...
class StreamTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('samsonframework\psr\Stream', $this->stream);
    }
    ...
    public function testCanInstantiteWithStreamResource()
    {
        ...
        $this->assertInstanceOf('samsonframework\psr\Stream', $stream);
    }
    ...
    {
        while (true) {
            $tmpnam = sys_get_temp_dir() . DIRECTORY_SEPARATOR . 'psr' . uniqid();
